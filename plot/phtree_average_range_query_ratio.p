...
set xlabel "range width (centered square)"
...
set ylabel "average range query time [ms]"
set title "Range query"

plot \
  "plot/data/phtree_average_range_query_ratio.dat" using 3 t 'initialization',\
...
plot \
  "plot/data/phtree_average_range_query_ratio.dat" using 5:xtic(2) t '#entries in range' ls 5
